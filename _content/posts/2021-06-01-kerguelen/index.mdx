...
lead: Captain Cook dismissed them as "Desolation Islands". But to ours eyes it’s too harsh a judgment.
date: 2020-03-09T21:10:37.426Z
tags:
    - Islands
---

import CitationWrapper from '@/components/Utility/citationWrapper.tsx';
...
<CitationWrapper
  citation={{
    ...
    contentType: "photo",
    contentHref: "https://commons.wikimedia.org/wiki/File:Anse_Tranchant.jpg",
...
>
  <Image
    section='kerguelen'
    imgName="Anse-Tranchant"
    description="Anse Tranchant"
    mobileImgName="Kerguelen-Arch"
  ></Image>
